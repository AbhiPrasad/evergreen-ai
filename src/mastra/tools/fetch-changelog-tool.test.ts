...
describe('Changelog PR/Issue Link Extraction', () => {
  it('should extract PR links correctly', () => {
    const content = '- feat(core): better cause data extraction ([#17375](https://github.com/getsentry/sentry-javascript/pull/17375))';
  ...
  it('should extract issue links correctly', () => {
    const content = '- feat(node): Add ignoreStaticAssets option ([#17368](https://github.com/getsentry/sentry-javascript/issues/17368))';
    const links = extractPRAndIssueLinks(content);
